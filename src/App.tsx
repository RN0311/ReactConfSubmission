  ...
  render() {
    return (
      <React.Fragment>
        ...
        <Styled.Heading>Image Classifier</Styled.Heading>
        <Styled.ImagesRow>
        ...
        <Styled.Description>{this.state.modelLoading && 'Model Loading!'} {this.state.sessionRunning && 'Processing Image'}</Styled.Description>
